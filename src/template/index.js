...
try {
  ...
  KssJadeReactGenerator = require('kss/generator/jade_react');
} catch (e) {
  KssJadeReactGenerator = require('../kss_jade_react_generator.js');
}

// Tell kss-node which generator this template uses.
module.exports.generator = KssJadeReactGenerator;
